      ...
      <section className='relative h-[60vh] overflow-hidden'>
        ...
        <div className='relative h-full container mx-auto px-4 flex items-end pb-12'>
          <div className='animate-fade-in'>
            ...
            <p className='text-3xl font-semibold text-primary mb-2'>320 RSD</p>
        ...
        <div className='grid md:grid-cols-2 gap-8 max-w-6xl mx-auto'>
          ...
          <div className='space-y-6'>
            ...
            <div className='bg-card rounded-2xl p-8 shadow-[var(--shadow-medium)] border border-border'>
              <h2 className='text-2xl font-bold mb-4 text-foreground'>Opis</h2>
              <p className='text-muted-foreground leading-relaxed mb-4'>
                Svaka palačinka se pravi sa ljubavlju i pažnjom, koristeći samo
                najkvalitetnije sastojke. Naše testo je pažljivo pripremljeno po
                tradicionalnom receptu koji se prenosio generacijama.
              </p>
